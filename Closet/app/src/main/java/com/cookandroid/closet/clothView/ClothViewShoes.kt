...
import com.cookandroid.closet.clothModi.ClothModiShoes
...
class ClothViewShoes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val position = intent.getIntExtra("positionShoes", 0)
        ...
        binding.clothModify.setOnClickListener {
            val intent = Intent(this, ClothModiShoes::class.java)
            intent.putExtra("modifyitemShoes", position)
