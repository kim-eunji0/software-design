...
class ClothModify : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val position = intent.getIntExtra("modifyitem", 0)
        ...
        binding.revisePicture.setOnClickListener {
        ...
        binding.reviseBtnComplete.setOnClickListener {
            ...
            val intent = Intent(this, ClothView::class.java)
